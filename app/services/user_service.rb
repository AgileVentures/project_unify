class UserService
  ...
  attrs_for_show :user_name, :mentor, :gender, :private, :email, :skill_list, :created_at
  attrs_for_form :user_name, :email, :gender, :mentor, :private, :password, :password_confirmation, :skill_list
  filter :user_name
  filter :skill_list
